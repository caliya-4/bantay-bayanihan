...
?>
<!DOCTYPE html><html><head><title>Reports & Analytics</title><link rel="stylesheet" href="../assets/css/style.css"></head><body>
...
<div class="main-content">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:20px;">
        ...
        <div class="card">
            <h3>Pending</h3><h2 style="color:red"><?=$pdo->query("SELECT COUNT(*) FROM emergencies WHERE status='pending'")->fetchColumn()?></h2>
        </div>
        <div class="card">
            <h3>Resolved/Handled Today</h3><h2 style="color:green"><?=$pdo->query("SELECT COUNT(*) FROM emergencies WHERE status IN ('resolved','handled') AND DATE(created_at)=CURDATE()")->fetchColumn()?></h2>
        </div>
        <div class="card">
    ...
    <h2 style="mt-5">Emergency Types</h2>
    <table>
